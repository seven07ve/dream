...
function widget($args, $instance) {
  ...
  $cat_posts = new WP_Query(
	...
	echo '<'.$instance["titleheading"].' class="'.$title_class.'">' . $instance["title"] . '</'.$instance["titleheading"].'><hr>';
	...
	{
		$cat_posts->the_post();
		$link_ext = get_post_meta($post->ID, "Tips-link-externo", "FALSE");
	?>
<?php
	if (get_post_meta($post->ID, "Tips-link-externo", "FALSE") <> ""){
		echo '<li class="cat-post-item"> <a class="post-title" href="'.$link_ext.'" rel="bookmark" target="_blank">';
?>
	<?php the_title(); ?>
	</a><br />
 <?php
 ...
 ?>
<li class="cat-post-item"> <a class="post-title" href="<?php the_permalink(); ?>" rel="bookmark" title="Permanent link to <?php the_title_attribute(); ?>" target="_blank">
		<?php the_title(); ?>
		</a><br />
	<?php
	}
