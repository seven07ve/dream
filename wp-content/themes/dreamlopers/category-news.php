...
<div class="pestanas">
	<a href="<?php echo get_site_url()."/en/we-are-hiring/"; ?>"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/pestana-aspirantes.png" class="img-responsive" alt="Image"></a>
</div>
