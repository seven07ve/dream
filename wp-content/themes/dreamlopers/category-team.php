	...
	<div class='container'>
		...
		<div class='row'>
			<div class='col-sm-12 features-box1'>
				<h4>Un grupo de compañeros que se consolida desde el comienzo de los estudios profesionales hasta estos tiempos. Pasando desde la amistad hasta la dedicacion profesional..</h4>
			</div>
			<div class='col-sm-12 features-box1'>
				<h4>Un equipo de ingenieros de sistemas graduados en la Universidad de los Andes, Mérida (ULA). Con altas capacidades en el desarrollo de software y complementadas con agilidad mental y facilidad para resolver problemas.</h4>
			</div>
			<div class='col-sm-12 features-box1'>
				<h4>Buenas caras a los problemas. Gusto por resolverlos.</h4>
			</div>
		</div>
	</div>
</div>
