...
<head>
	...
	<link rel="stylesheet" media="all" href="<?php echo get_stylesheet_directory_uri(); ?>/assets/stylesheets/style_portfolio.css" />
	<link rel="stylesheet" media="all" href="<?php echo get_stylesheet_directory_uri(); ?>/assets/stylesheets/cube.css" />
	<link rel="stylesheet" media="all" href="<?php bloginfo( 'stylesheet_url' ); ?>" />
	<!--js-->
	<script src="<?php echo get_stylesheet_directory_uri(); ?>/assets/javascripts/jquery.min.js"></script>
